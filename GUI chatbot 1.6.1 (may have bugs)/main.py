...
if __name__ == '__main__':
    ...
    def commands(command) -> None:
        if command.lower() == "$chat_history" or command.lower() == "$chathistory":
            ...
            display_message(f"Chat history: {messages}")
    ...
    def open_hyperparameters_window() -> None:
        ...
        OAuth_credentials_token_save_location_label = ttk.Label(frame, font=roboto_font_, text="OAuth credentials token save location:")
